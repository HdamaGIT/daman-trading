...
def load_configuration() -> AppConfig:
    ...
    try:
        ...
        logging.info("Main System: Config loaded successfully.")
        return config
...
def load_data(config: AppConfig) -> Optional[pd.DataFrame]:
    ...
    try:
        ...
        logging.info("Main System: Data loaded successfully.")
        return df_data
    except Exception as e:
...
def generate_strategy_signals(df_data: pd.DataFrame) -> Optional[Dict[str, pd.DataFrame]]:
    ...
    try:
        ...
        logging.info("Main System: Strategy signals generated successfully.")
...
def run_backtesting(strategy_output: pd.DataFrame) -> Optional[Any]:
    ...
    try:
        ...
        logging.info("Main System: Backtesting completed successfully.")
        return backtester
    except Exception as e:
...
def main():
    ...
    logging.info("Main System: Completed successfully.")
    return backtester
