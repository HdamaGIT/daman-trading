...
def inputs():
    ...
    ### Algorithm
    # version = 'sp500_v1'
    version = 'spreadbet_nasdaq_v1'

    ### Database name
    db = '/Users/hughdaman/PycharmProjects/202211_IGTrading/mydatabase.db'
    # db = '/Volumes/My AFP Volume/database.db'

    ### Details for saving csv files
    filepath = '/Users/hughdaman/PycharmProjects/202211_IGTrading/csv/'
